...
export const CANONICAL_PORT_COORDINATES: Record<string, { latitude: number; longitude: number }> = {
  KARN_001: { latitude: 14.8055, longitude: 74.1465 }, // Karwar (Baithkol Fishing Harbor)
  KARN_002: { latitude: 13.6395, longitude: 74.7200 }, // Kundapura (Gangolli / Kundapura Port)
  KARN_003: { latitude: 14.4285, longitude: 74.3760 }, // Kumta (Tadri Fishing Harbor)
  KARN_004: { latitude: 14.7085, longitude: 74.2940 }, // Ankola (Belekeri Landing)
  KARN_005: { latitude: 12.7980, longitude: 74.8810 }, // Someshwara (Ullal South Landing Center)
  KARN_006: { latitude: 13.9785, longitude: 74.5670 }, // Bhatkal (Bhatkal Fishing Bunder)
  KARN_007: { latitude: 13.3485, longitude: 74.7265 }, // Malpe Offshore Base (Malpe Main Port)
  KARN_008: { latitude: 13.7085, longitude: 74.6715 }, // Maravanthe (Maravanthe Beach Wharf)
  KARN_009: { latitude: 13.8560, longitude: 74.6305 }, // Baindur (Koderi Fishing Harbor)
  KARN_010: { latitude: 13.6270, longitude: 74.7100 }, // Kundapura Coast (Kodi Beach Landing)
  KARN_011: { latitude: 13.6385, longitude: 74.7135 }, // Gangolli (Gangolli Fisheries Jetty)
  KARN_012: { latitude: 13.9350, longitude: 74.6050 }, // Shiroor (Shiroor Landing Center)
  KARN_013: { latitude: 14.5360, longitude: 74.3410 }, // Gokarna (Tadadi / Gokarna Harbor)
  KARN_014: { latitude: 12.8610, longitude: 74.8610 }, // Mangalore Deep Sea Base (Mangalore Bunder)
  KARN_015: { latitude: 13.0080, longitude: 74.8200 }, // Surathkal (Surathkal Beach Landing)
  KARN_016: { latitude: 14.2820, longitude: 74.4690 }, // Honnavar (Kasarkod / Honnavar Port)
  KARN_017: { latitude: 14.7120, longitude: 74.2970 }, // Belekeri (Belekeri Port)
  KARN_018: { latitude: 13.3485, longitude: 74.7265 }, // Malpe (Malpe Main Fishing Bunder)
  KARN_019: { latitude: 13.9785, longitude: 74.5670 }, // Bhatkal Port
  KARN_020: { latitude: 14.0950, longitude: 74.5090 }, // Murudeshwar (Murudeshwar Bunder)
  KARN_021: { latitude: 14.0950, longitude: 74.5090 }, // Netrani Base (Murudeshwar Harbor)
  KARN_022: { latitude: 13.2240, longitude: 74.7640 }, // Kaup (Kaup Light House Landing)
  KARN_023: { latitude: 12.8080, longitude: 74.8780 }, // Ullal (Ullal Sea Front Landing)
  KARN_024: { latitude: 14.1850, longitude: 74.5010 }, // Manki (Manki Landing Center)
  KARN_025: { latitude: 12.8610, longitude: 74.8610 }, // Mangalore (Mangalore Old Port / Bunder)
};
