...
export const mockRiskZones: RiskZone[] = [
  {
    ...
    waveHeight: 3.2,
    windSpeed: 28,
    description: 'High waves and strong winds. Cyclonic conditions developing.',
  ...
  },
  {
    ...
    waveHeight: 2.1,
    windSpeed: 18,
    description: 'Moderate swell expected. Caution for small vessels.',
  ...
  },
  {
    ...
    waveHeight: 0.8,
    windSpeed: 8,
    description: 'Calm conditions. Safe for all vessel types.',
